...
namespace Calculator
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //флаг для стирания или просто добавить к текущему значку отображения
        ...
        //Get/Set Значение ячейки памяти
        ...
        //Текущий значение на дисплее калькулятора
        ...
        private double Calc(Operation LastOper)
        {
            ...
            catch
            {
                ...
                Paper.AddResult("Ошибка");
                MessageBox.Show(parent, "Операция не может быть выполнена", parent.Title);
            }
        ...
        private void AddToDisplay(char c)
        {
            if (c == '.')
            {
                if (Display.IndexOf('.', 0) >= 0)  //уже существует
                    return;
                Display = Display + c;
            }
            else
            {
                ...
                if (c == '\b')  //backspace ?
                {
                    ...
                    else
                    {
                        ...
                        Display = Display.Remove(i - 1, 1);  //удалить последний символ
                    }
                }
        ...
        {
            Window parent = (Window)MyPanel.Parent;
            MessageBox.Show(parent, parent.Title + " - By Vitalii Krivoruchko ", parent.Title, MessageBoxButton.OK, MessageBoxImage.Information);
        }
